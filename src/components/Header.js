...
const Header = () => {
  ...
  const getSearchResult = async () => {
    ...
    const res = await fetch(GOOGLE_SEARCH_API + searchQuery);
  ...
  return (
    <div className="grid grid-flow-col p-2 m-2 shadow-lg sticky top-0 bg-white z-50 ">
      <div className="flex col-span-1">
        ...
        <img
          className="h-8 mx-creat2"
          alt="logo"
          src="https://imgs.search.brave.com/XZBRj5-Gg5ULv-hVVhtw_3MfmT-JMr1Ht2fhptzVODc/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly90NC5m/dGNkbi5uZXQvanBn/LzA2LzA5LzEzLzMx/LzM2MF9GXzYwOTEz/MzEyMl91NXZhaXlD/SHNMNVVxdGRyU05y/VjVsbEwySkMxb1lX/aS5qcGc"
        />
      </div>
      ...
      <div className="col-span-10 px-10 ">
        ...
        {suggestions.length > 1 && showSuggestions && (
          <div className="fixed bg-white w-[560px] mt-2 rounded-lg">
            <ul className="py-5 px-5  ">
              {suggestions.map((suggestion, index) => (
                <li className="hover:bg-gray-100 py-1" key={index}>
                  {"🔍" + suggestion}
                </li>
              ))}
            </ul>
